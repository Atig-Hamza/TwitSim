...
const PostCard = ({ post, isMain = false }) => {
    const { author, content, likesCount, repliesCount, viewsCount, createdAt, _id } = post;
            ...
            <div className="p-4 border-b border-[#2f3336]">
                <div className="flex gap-3 items-center mb-4">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-gray-500 text-[15px]">@{author?.handle}</span>
                    </div>
                </div>
                ...
                <div className="flex gap-6 border-b border-[#2f3336] py-2 mb-3 text-sm">
                    <div><span className="font-bold text-white">{viewsCount || 0}</span> <span className="text-gray-500">Views</span></div>
                    <div><span className="font-bold text-white">{likesCount || 0}</span> <span className="text-gray-500">Likes</span></div>
            ...
            <div className="p-4 border-b border-[#2f3336] hover:bg-[#080808] transition-colors">
                <div className="flex gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[#e7e9ea] whitespace-pre-wrap text-[15px] leading-5 mt-0.5 mb-3">{content}</p>
                        ...
                        <div className="flex justify-between text-gray-500 max-w-[425px] -ml-2">
                            ...
                            <div className="group flex items-center gap-1 hover:text-[#f91880] transition-colors">
                                ...
                                {(likesCount || 0) > 0 && <span className="text-[13px]">{likesCount}</span>}
                            </div>
                            <div className="group flex items-center gap-1 hover:text-[#1d9bf0] transition-colors">
                                <div className="p-2 rounded-full group-hover:bg-[#1d9bf0]/10 transition-colors">
                                    <BarChart2 size={18} />
